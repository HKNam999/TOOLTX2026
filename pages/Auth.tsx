  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!isLogin) {
        ...
        // Auto login after register or ask to login? Requirement says "login after register".
        // Let's just login them in immediately for UX
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-400 text-sm">
            ...
            <button
              ...
              className="text-gold-500 font-bold ml-2 hover:underline focus:outline-none"
            >
